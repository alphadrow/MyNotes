...
public class NoteTranslate {
    ...
    public static Note documentToNote(String id, Map<String, Object> doc) {
        Note result = new Note((String) doc.get(Fields.NAME), (String) doc.get(Fields.DESCRIPTION), new Date((Long) doc.get(Fields.DATE_OF_CREATION)), stringToImportance((String) doc.get(Fields.IMPORTANCE)));
        result.setId(id);
        return result;
    }
